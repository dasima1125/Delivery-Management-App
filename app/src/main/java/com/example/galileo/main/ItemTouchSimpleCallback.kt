...
class ItemTouchSimpleCallback : ItemTouchHelper.SimpleCallback(
    ...
    override fun onMove(
        ...
        // 어댑터 획득
        val adapter = recyclerView.adapter as Move_UserAdapter_main
    ...
    private fun getViewWidth(viewHolder: RecyclerView.ViewHolder): Float{
        val viewWidth = (viewHolder as Move_UserAdapter_main.ViewHolder).itemView.findViewById<TextView>(R.id.remove_text_view).width
        return viewWidth.toFloat()
    }

    private fun getView(viewHolder: RecyclerView.ViewHolder): View {
        return (viewHolder as Move_UserAdapter_main.ViewHolder).itemView.findViewById(R.id.swipe_view)
    }
